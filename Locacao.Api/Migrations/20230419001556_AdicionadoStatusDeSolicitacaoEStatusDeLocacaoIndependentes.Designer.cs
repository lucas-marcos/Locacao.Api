...
namespace Locacao.Api.Migrations
{
    ...
    [Migration("20230419001556_AdicionadoStatusDeSolicitacaoEStatusDeLocacaoIndependentes")]
    partial class AdicionadoStatusDeSolicitacaoEStatusDeLocacaoIndependentes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Locacao.Api.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Locacao.Api.Models.Endereco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Locacao.Api.Models.Locacao", b =>
                {
                    ...
                    b.Property<string>("UsuarioQueSolicitouId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Locacao.Api.Models.Locacao", b =>
                {
                    b.HasOne("Locacao.Api.Models.Endereco", "EnderecoDoEvento")
                        .WithMany()
                        .HasForeignKey("EnderecoDoEventoId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Locacao.Api.Models.ApplicationUser", null)
                        .WithMany()
